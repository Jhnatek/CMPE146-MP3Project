...
// changed function name to gpio0____attach_interrupt(uint32_t pin, gpio_interrupt_e interrupt_type, function_pointer_t
// callback) bc had the same function in interrupts.c Our main() should configure interrupts to invoke this dispatcher
// where we will invoke user attached callbacks You can hijack 'interrupt_vector_table.c' or use API at
// lpc_peripherals.h
